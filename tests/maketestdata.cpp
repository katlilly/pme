...
int main(int argc, char *argv[])
	...
	FILE *output = fopen("../testdata/testdata.bin", "w");
	FILE *output2 = fopen("../testdata/sg_testdata.bin", "w");

	/*
	  Read in postings lists and write out the first 70 to a file to use
